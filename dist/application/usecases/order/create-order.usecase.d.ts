...
export declare class CreateOrderUseCase {
    ...
    constructor(orderRepository: IOrderRepository, orderItemRepository: IOrderItemRepository, customerRepository: ICustomerRepository, productRepository: IProductRepository, customerProductPriceRepository: ICustomerProductPriceRepository, stockMovementRepository: IStockMovementRepository, paymentRepository: IPaymentRepository, dataSource: DataSource);
