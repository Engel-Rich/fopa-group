...
exports.PaymentReferenceGenerator = void 0;
class PaymentReferenceGenerator {
    static counter = 0;
    static generate(paymentMethod) {
        const now = new Date();
    ...
    static getPrefixForPaymentMethod(paymentMethod) {
...
exports.PaymentReferenceGenerator = PaymentReferenceGenerator;
//# sourceMappingURL=payment-reference-generator.js.map