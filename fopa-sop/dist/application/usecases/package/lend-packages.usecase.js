...
exports.LendPackagesUseCase = void 0;
...
let LendPackagesUseCase = class LendPackagesUseCase {
    customerRepository;
    ...
    async execute(dto, userId) {
        ...
        const transaction = new package_transaction_entity_1.PackageTransaction(dto.customerId, package_transaction_entity_1.PackageTransactionType.LEND, dto.quantity, userId, dto.notes);
...
exports.LendPackagesUseCase = LendPackagesUseCase;
exports.LendPackagesUseCase = LendPackagesUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('ICustomerRepository')),
    __param(1, (0, common_1.Inject)('IPackageTransactionRepository')),
    __metadata("design:paramtypes", [Object, Object])
], LendPackagesUseCase);
//# sourceMappingURL=lend-packages.usecase.js.map